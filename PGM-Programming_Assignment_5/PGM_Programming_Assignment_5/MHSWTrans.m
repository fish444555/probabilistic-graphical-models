...
%         display(['selected_vars =  ', num2str(selected_vars(i))])
%     end
%     display(['old_value =  ', num2str(old_value)])
%     display(['LogR(1) =  ', num2str(LogR(1))])
%     display(['LogR(2) =  ', num2str(LogR(2))])
    %% mine end
...
% display(['new_value =  ', num2str(new_value)])
...
% display(['log_QY_ratio =  ', num2str(log_QY_ratio)])
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% mine has errer
% log_temp = LogProbOfJointAssignment(F, A)-...
%     LogProbOfJointAssignment(F, A_prop);
% % p_acceptance = exp(log_temp);
% p_acceptance = min(1,exp(log_temp));
%% mine end

%% others 
% Notice 
% https://class.coursera.org/pgm-2012-002/forum/thread?thread_id=1012
% https://github.com/tomtung/pgm-class/blob/master/PGM_Programming_Assignment_5/MHSWTrans.m
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% display(['p_acceptance =  ', num2str(p_acceptance)])
