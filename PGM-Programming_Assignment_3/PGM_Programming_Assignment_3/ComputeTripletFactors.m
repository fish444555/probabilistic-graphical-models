...
for i = 1:length(tripletList)
    temp1 = tripletList(i).chars(1);
    temp2 = tripletList(i).chars(2);
    temp3 = tripletList(i).chars(3);
    indx = AssignmentToIndex([temp1 temp2 temp3], [K K K]);
    valt(indx) = tripletList(i).factorVal;
end
for i = 1:n-2
