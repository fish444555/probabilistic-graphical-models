...
for i = 1:numPeople
    if(pedigree.parents(i) == 0)
        ...
        factorList(i) = genotypeGivenParentsGenotypesFactor(numAlleles,...
            i, pedigree.parents(i,1), pedigree.parents(i,2));
    end
end
for i = numPeople+1:2*numPeople
    factorList(i) = phenotypeGivenGenotypeFactor(alphaList, ...
        factorList(i-numPeople).var(1), i);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  